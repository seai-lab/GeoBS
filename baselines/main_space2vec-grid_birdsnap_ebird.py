...
from TorchSpatial.trainer_space2vec_grid import train, train_ssi_debias
from TorchSpatial.tester_space2vec_grid import test
...
def main():
    ...
    # - import configs
    with open("configs_space2vec-grid_birdsnap_ebird.json", "r") as f:
