...
def compute_acc_batch(
    ...
    if params['save_results'] & (prior_type == "no_prior"):
        ...
        results_csv_path = f"TorchSpatial/eval_results/eval_{params['dataset']}_{params['meta_type']}_{params['eval_split']}_no_prior.csv"
...
def compute_regression_acc(params, model, val_feats, val_locs, val_labels,logger):
    ...
    if params['save_results']:
        ...
        csv_filename = f"TorchSpatial/eval_results/eval_{params['dataset']}_{params['meta_type']}_{params['eval_split']}_{params['spa_enc_type']}.csv"
...
def compute_acc_predict_result(
    ...
    results_df.to_csv(f"TorchSpatial/eval_results/eval_{params['dataset']}_{params['meta_type']}_{params['eval_split']}_{params['spa_enc_type']}.csv", index=True)
