...
from .SphereGridSpatialRelationPositionEncoder import SphereGridSpatialRelationPositionEncoder

class SphereGridSpatialRelationLocationEncoder(LocationEncoder):
    def __init__(
        self,
        spa_embed_dim,
        coord_dim=2,
        ...
        self.position_encoder = SphereGridSpatialRelationPositionEncoder(
            coord_dim=coord_dim,
